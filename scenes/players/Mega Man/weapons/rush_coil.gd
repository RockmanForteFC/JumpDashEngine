...
#      Constants
#-------------------------------------------------
const Rush: Resource = preload("res://scenes/players/Mega Man/projectiles/rush_coil/rush_coil.tscn")
