...
#      Constants
#-------------------------------------------------
const Projectile: Resource = preload("res://scenes/players/Mega Man/projectiles/wind_storm/wind_storm.tscn")
...
#-------------------------------------------------
func can_use() -> bool:
	var on_screen_bullets: Array = get_tree().get_nodes_in_group("WindStormP%s" % owner.player_number)
...
func _get_bullet() -> Node:
	...
	bullet.add_to_group("WindStormP%s" % owner.player_number)
