...
#      Constants
#-------------------------------------------------
const Projectile: Resource = preload("res://scenes/players/Mega Man/projectiles/solar_blaze/solar_blaze_shot.tscn")
const SOLAR_BLAZE_MAX_ON_SCREEN:int = 1
#-------------------------------------------------
#      Signals
#-------------------------------------------------
...
func _get_bullet() -> Node:
	...
	bullet.add_to_group("SolarBlazeP%s" % owner.player_number)
