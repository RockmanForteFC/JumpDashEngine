...
#      Constants
#-------------------------------------------------
const Projectile: Resource = preload("res://scenes/players/Mega Man/projectiles/metal_blade/metal_blade.tscn")
const METAL_BLADE_MAX_ON_SCREEN:int = 3
#-------------------------------------------------
#      Signals
#-------------------------------------------------
...
func _process(delta):
	...
	elif Physics.is_action_pressed("action_up_p1") and Physics.is_action_pressed("action_right_p1"):
...
func _get_bullet() -> Node:
	...
	bullet.add_to_group("MetalBladeP%s" % owner.player_number)
