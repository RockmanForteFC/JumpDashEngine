...
#      Constants
#-------------------------------------------------
const Projectile: Resource = preload("res://scenes/players/Mega Man/projectiles/water_balloon/water_balloon.tscn")
const WATER_BALLOON_MAX_ON_SCREEN:int = 99
#-------------------------------------------------
#      Signals
#-------------------------------------------------
...
#-------------------------------------------------
func can_use() -> bool:
	var on_screen_bullets: Array = get_tree().get_nodes_in_group("WaterBalloonP%s" % owner.player_number)
	return on_screen_bullets.size() < WATER_BALLOON_MAX_ON_SCREEN and weapon_energy > 0
...
func _get_bullet() -> Node:
	...
	bullet.add_to_group("WaterBalloonP%s" % owner.player_number)
