...
#      Constants
#-------------------------------------------------
const Projectile: Resource = preload("res://scenes/players/Mega Man/projectiles/silver_tomahawk/silver_tomahawk.tscn")
const SILVER_TOMAHAWK_MAX_ON_SCREEN:int = 2
#-------------------------------------------------
#      Signals
#-------------------------------------------------
...
#-------------------------------------------------
func can_use() -> bool:
	var on_screen_bullets: Array = get_tree().get_nodes_in_group("SilverTomahawkP%s" % owner.player_number)
...
func _get_bullet() -> Node:
	...
	bullet.add_to_group("SilverTomahawkP%s" % owner.player_number)
