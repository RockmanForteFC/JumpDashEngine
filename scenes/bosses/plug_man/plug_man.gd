...
#      Constants
#-------------------------------------------------
const offset_L:int = -11
const offset_R:int = 8
#-------------------------------------------------
#      Signals
#-------------------------------------------------
...
func set_facing_direction(dir: Vector2) -> void:
	...
	$CharacterSprites/AnimatedSprite.offset.x = offset_R if dir == Vector2.RIGHT else offset_L
	$CharacterSprites/Sprite.offset.x = offset_R if dir == Vector2.RIGHT else offset_L
